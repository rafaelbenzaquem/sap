...
import br.jus.trf1.sap.externo.jsarh.servidor.exceptions.ServidorError404NotFountException;
...
public class RelatorioService {
    ...
    public byte[] gerarRelatorio(String matricula, LocalDate inicio, LocalDate fim) throws JRException {
        ...
        var servidor = servidorService.buscaDadosServidor(matricula).
                orElseThrow(() -> new ServidorError404NotFountException("Servidor com matrícula '%s' não encontrado!"));
