...
public final class RegistroJpa implements Comparable<RegistroJpa> {
    ...
    private List<RegistroJpa> registrosAntigos;
    ...
    @Override
    public int compareTo(RegistroJpa oRegistro) {
    ...
    public boolean equals(Object o) {
        ...
        RegistroJpa registro = (RegistroJpa) o;
