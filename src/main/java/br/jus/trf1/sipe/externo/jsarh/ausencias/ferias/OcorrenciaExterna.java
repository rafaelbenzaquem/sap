...
@Getter
public enum OcorrenciaExterna {

    SUSPENSAS(7), MARCADAS(1), GOZADAS(2), INTERROMPDIAS(5);

    private final int valor;

    OcorrenciaExterna(int valor) {
        this.valor = valor;
    }

    public static OcorrenciaExterna valueOf(int value) {
        return switch (value) {
            case 7 -> SUSPENSAS;
            case 1 -> MARCADAS;
            case 2 -> GOZADAS;
    ...
    public static OcorrenciaExterna parse(String name) {
