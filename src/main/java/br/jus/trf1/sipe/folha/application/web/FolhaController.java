package br.jus.trf1.sipe.folha.application.web;

import br.jus.trf1.sipe.folha.domain.service.FolhaServiceAdapter;
import br.jus.trf1.sipe.folha.domain.model.Mes;
import br.jus.trf1.sipe.folha.application.web.dto.FolhaResponse;
...
public class FolhaController {
    ...
    private final FolhaServiceAdapter folhaServiceAdapter;

    public FolhaController(FolhaServiceAdapter folhaServiceAdapter) {
        this.folhaServiceAdapter = folhaServiceAdapter;
    }
