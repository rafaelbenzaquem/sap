...
public class FolhaService {
    ...
    public Folha buscarFolha(String matricula, Mes mes, int ano) {
        return folhaRepository.buscarFolha(matricula, mes.getValor(), ano).orElseThrow(() -> new RuntimeException("Folha inexistente"));
    }
