...
public record FrequencialEspecialExternaResponse(
    ...
    public FrequenciaEspecialExterna toModel(String matricula) {
        return new FrequenciaEspecialExterna("especial:%s:%d".formatted(matricula,id), inicio, fim, descricao, sei);
    }
}
